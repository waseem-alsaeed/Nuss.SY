...
function check_button(){
	...
	if(button==1){
		...
		$("#gallery-header-center-left-title").html('كل الأقسام');
		}
	if(button==2){
		$("#filter-studio").addClass(button_class);
		$("#gallery-header-center-left-title").html('المكتب الإداري');
		}
	if(button==3){
		$("#filter-landscape").addClass(button_class);
		$("#gallery-header-center-left-title").html('الهيئات الإدارية');
		}	
}
